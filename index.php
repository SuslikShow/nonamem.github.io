...
<head> <title>CSGOHSA!</title> 
<base > <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"> 
<meta name="author" content="CSGOHSA.com"/> 
<meta name="keywords" content="jackpot, CSGOHSA, bestpot, gambling, csgo, counter strike global offensive"> <meta name="description" content="The best CSGO Jackpot Gambling on CSGOHSA only. Looking for money? Looking for knives and expensive items? Come gamble!"> 
...
<link type="text/css" rel="stylesheet" media="all" href="frontend/css/front7f6f.css?112"> 
...
<meta name="theme-color" content="#ffffff"> <meta property="og:title" content="The Best CSGO Jackpot Gambling Only"> 
<meta property="og:site_name" content="CSGOEvo"> <meta property="og:url" content="index.php"> 
<meta property="og:description" content="The best CSGO Jackpot Gambling on CSGOEvo only. Looking for money? Looking for knives and expensive items? Come gamble!"> 
...
<li class="separator"></li> <li class="mini"><a href="http://support.CSGOHSA.com/" class="support" target="_blank"><i class="fa fa-life-ring">
...
<a href="index.php" class="sitename transition" data-page="play">CSGO<span class="transition">HSA</span>.com - Evolve your skins!</a><ul id="right-section"> 

<li class="el promo leadtext">Add <span>CSGOHSA.com</span> to your steam name and get <span>+6%</span> bonus<br/> to your winnings! (relog website)</li> 
 ...
 <?php
  ...
  <?php mysql_query("UPDATE users SET lastseen=".$timenow." WHERE steamid=".$_SESSION['steamid'].""); ?>
 	...
 	<a class="deposit" href="https://steamcommunity.com/tradeoffer/new/?partner=237132759&token=K6SiH4oW">MAKE A DEPOSIT </a>
 ...
 <?php endif; ?>
  <li class="el" id="langs"> <div class="btn-group"> <button type="button" class="dropdown-toggle lang-en" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> EN <span class="caret"></span>
   ...
   </ul> </div> </li> </ul> </div> <div id="top-bar"> <div id="spinner" class=" col-lg-13"> <div class="line"></div> <div class="spinner"> 
   ...
   <span id="users-online" class="h3"><?php
										...
										?></span> <?php echo $msg[$lang]["gtd"]; ?> </div> </div> <div class="col-xs-12 col-sm-8 col-md-8 icon-col"> 
   <div class="games-today ico"> <div class="img"></div> <span id="games-today" class="h3"><?php
                    ...
                    echo mysql_num_rows($result2); ?></span> <?php echo $msg[$lang]["ptd"]; ?> </div> </div> <div class="col-sm-8 col-md-8 icon-col hidden-xs"> <div class="biggest-win ico"> 
   <div class="img">
   ...
   <div class="ico"> </div>
   <ul> <li>You've deposited - <span id="myitems">0</span> (of <span>10</span>) item(s).</li> <li>Probably to win <span id="mychance">0%</span>. Min bet <span>$0.5</span></li> </ul> </div>  </div>
   <div align="center" class="col-lg-5 border-left social col hidden-md hidden-xs hidden-sm"> 
   </br><span style="
    color: #3E83BF;
">All players</span> who has participated in a <span style="
    color: #3E83BF;
">jackpot roll</span> are
automatically entered to win a <span style="
    color: #3E83BF;
">Karambit Fade/Slaughter</span> - your pick!</br>
Ends September 8
</div> </div> 
   <div id="content"> <div class="col-lg-9 affix-room scrollbar"> <div id="affix-room" class="">
...
<?php else: ?>
  Time left: <h4 id="countdown-timer"><span id="timeleft">0</span></h4>
	<a class="btn btn-primary btn-lg" href="https://steamcommunity.com/tradeoffer/new/?partner=237132759&token=K6SiH4oW" target="_blank" ><?php echo $msg[$lang]["ingame"]; ?> </a>
...
<?php endif; ?>
   ...
   <div class="col-lg-6 affix-players">
  ...
  ?>
    ...
    <div class="col-xs-24 messages messages-img">
...
while($rowd=mysql_fetch_array($query)):
  ...
  <?php endwhile; ?>
   ...
   <h2>CSGOHSA - Rules/FAQ</h2> <h3>Evolve Your Skins!</h3>
...
- Your first deposit gives you a +5% win chance.<br/>- By adding "CSGOEHSA.com" to your steam name and re-logging the site, you get +6% extra on your winnings!<br/><h4>Current Promotions:</h4>
...
- The site takes 10% commission (4% with CSGOHSA.com) for upkeep, advertising, give-aways and site development.
...
<br/>Questions and Inquires can be sent to: support@csgoevo.com<br/><br/> Deposit today and try your luck! Evolve Your Skins!<br/>
-CSGOEVO Team <a class="close" data-page="play"></a> </div> <div class="site rules col-xs-24 col-sm-18 col-md-14 col-lg-12"> 
...
You are bound to our terms as long as you are affiliating yourself with any aspects of CSGOEvo. 
...
We reserve the rights to have anything on CSGOEvo or affiliated changed, whenever, without consent.<br/>
<h4>License of service usage:</h4> 
CSGOEvo and/or its owners own the intellectual property rights and originality that is published on CSGOEVO (in any form). Subject to the license below, all these intellectual property rights are reserved. <h4>
Accounts/Privacy:</h4> The account you authorize with us through Steam (https://steamcommunity.com) must be your own. Your privacy is kept 100% secure and will never be distributed externally. 
   <h4>Fair Play</h4>
   We respect fair play. A MAXIMUM of 4% will be taken from jackpot winners with "CSGOHSA.com" and up to 10% without for further website development, give-aways and upkeep. All users on this website are expected to be "legit" users of the community as we hold the right to freeze your account without warning if suspicion is raised.
   <h4>Missing Items</h4> 
   If you are missing any items deposited or returned from CSGOHSA.com, you have 30 days to claim your items through a support ticket. You will be notified after 30 days. Items will not be returned if put into the jackpot and lost. All jackpot betting are FINAL.
   <h4>Valuation:</h4> CSGOEvo items are valued from SteamAnalyst's database backed up with the Steam Market. Prices are subjected to change any time without notice. <br/> All deposits are final after the user confirms them on the website, there will be no refunds, since the user agrees to enter the jackpot. Agrees he is liable to losing
       his skins to another user and agrees CSGOEvo is not liable for losses of any kind. 
	   ...
	   <h4>Skin Deposits:</h4> CSGOHSA.com only allows items from game “Counter Strike: Global Offensive” (non-affiliated). These skins MUST be your own.Items from different games will be declined. 
	   <h4>Variation:</h4>
        CSGOHSA.com may revise these terms and conditions at all time. Revised terms and conditions will apply to the use of this website from the date of the publication of the revised terms and conditions on this website. Please check this page regularly to ensure you are familiar with the current version. 
		...
		The third-party links that are shown outside CSGOHSA.com is not our responsibility. We are unaffiliated unless mentioned. That includes the content, privacy, or practices of external parties.
		<h4>Indemnification:</h4>
		By BEING on the site, you agree to defend CSGOEvo and any staff affiliated against all and any claims, losses, obligations, costs and expenses arisen from breaking any section of our terms or any claim that you have broken any section of our terms.
		<h4>Affiliation:</h4>
